...
export const NavBar: React.FC<NavBarProps> = ({ items }) => {
  ...
  return (
    <>
      ...
      <nav className="hidden md:block fixed top-6 left-1/2 transform -translate-x-1/2 z-50 bg-white/70 backdrop-blur-md px-8 py-3 rounded-full shadow-sm border border-gray-200/50">
